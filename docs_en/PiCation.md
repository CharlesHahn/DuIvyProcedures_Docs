...
![Pistacking_Distance](../docs/static/PiCation_Distances.png)

![PiCation_Offset](../docs/static/PiCation_Offsets.png)

Then output occupancy plots for all PiCation:

![PiCation_Occupancy](../docs/static/PiCation_Existence_Map.png)
