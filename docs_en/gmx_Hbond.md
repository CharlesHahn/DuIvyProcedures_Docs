...
![hbond_number](../docs/static/gmx_Hbond_hbnum.png)

![hbond_map](../docs/static/gmx_Hbond_hbmap.png)

Then DIP will calculate the distance and angle changes over time for the hydrogen bonds with the highest occupancy:

![hbond_distance](../docs/static/gmx_Hbond_hbdistall.png)

![hbond_angle](../docs/static/gmx_Hbond_hbangall.png)

It will also visualize the occupancy of the top hydrogen bonds:

![hbond_top](../docs/static/gmx_Hbond_top_hbmap.png)
