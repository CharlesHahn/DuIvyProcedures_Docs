...
![Pistacking_Distance](../docs/static/PiStacking_Distances.png)

![PiStacking_Angle](../docs/static/PiStacking_Angles.png)

![PiStacking_Offset](../docs/static/PiStacking_Offsets.png)

Then output occupancy plots for all PiStacking and occupancy plots for different types of PiStacking:

![Pistacking_Occupancy](../docs/static/PiStacking_Existence_Map.png)

![Pistacking_Type_Occupancy](../docs/static/PiStacking_Type_Map.png)
