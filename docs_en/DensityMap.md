...
![DensityMap_X](../docs/static/DensityMap_Density_distribution_X_axis.png)
...
![DensityMap_protein_XY](../docs/static/DensityMap_Density_XY_ave_protein.png)
...
![DensityMap_protein_ligand_XY](../docs/static/DensityMap_Density_XY_resname_ZIN-protein_ave.png)
...
![DensityMap_protein_ligand_Y_frame1](../docs/static/DensityMap_Density_XZ_resname_ZIN-protein_3.0nm.png)

![DensityMap_protein_ligand_Y_frame2](../docs/static/DensityMap_Density_XZ_resname_ZIN-protein_4.0nm.png)

Users can also combine the sliced image files into videos or gif files, which looks interesting. For example:

![gif](../docs/static/DensityMap_split.gif)
