...
Time-lagged independent component analysis (TICA) is a dimensionality reduction method. This module can be used to calculate tICA for selected atom groups. tICA can be performed on coordinates or on protein backbone dihedral angles.
...
Here we list the parameters for both coordinate-based and dihedral-based tICA analysis.
...
`lag`: The lag time parameter for tICA. This module uses the deeptime.decomposition.TICA function for calculation.
...
![TICA](../docs/static/TICA_tica12.png)

![TICA_d](../docs/static/TICA_d_tica12.png)
